...
<img className="w-full aspect-[4/3] object-cover grayscale hover:grayscale-0 transition-all duration-500" data-alt="Surgical team performing a complex procedure under bright overhead lights in a sterile modern operating theatre" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB3cc49jb9K_7GanUAKDiiZNmcZPxkdF7OhyjwDVOMH_zn0cGUDSEc2LBlDBAnz-2HeCtTTl2b4k8KBERkwdUSwUNlThxNh34FMQgG2oSkSlWI9F1OTlwpV7gSWgRmfYXTt6T0E0ZANW92Eelg2q17VOmWZzsIIE7i88x9UAjpdvZGA8DKjBe_D5z7lE14RAXWnTqJ6H2IpFeN_3mhq1ViTgD1vLYWHg_Z-Khmn0OW6BtXAGoIuivwmWKQRVZ_4chYjpjQGnTQV6Q"/>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
<div className="md:col-span-3">
<img className="w-full aspect-[4/3] object-cover grayscale hover:grayscale-0 transition-all duration-500" data-alt="Interior of a luxury hospital lobby with marble floors, minimalist wooden furniture and large floor to ceiling windows" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDOc7sliAZnxV1AsuYPWukEzVu1lniP7aDPOsFa370N1kls-JohNqrrueM0xll5PmWyNWqNya_vPiaRg7B4oQZBMDCUByvpMlevt2IvEqT1auD3Su0imEZlCGtjqo0t7hTN3KoI0mB_HrA1MDosCQc5ztMSWxNXSevRNAtpuGrHF6I2ZG1ignFXRrzKrCOG7OveQxZ9-wgZJns_sT9j6PqyxIGpGx7lDoakAOoNgb4__P8Yu3u9GmkCEG3mDq3AdHanSCb_3KG-sw"/>
</div>
<div className="md:col-span-7">
...
<div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
<div className="md:col-span-3">
<img className="w-full aspect-[4/3] object-cover grayscale hover:grayscale-0 transition-all duration-500" data-alt="Close up of a doctor checking a digital tablet with medical scans in a dimly lit consultation room" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDLsVS9eowToMOGqL1MwN0UFT-s9bUN5aixZXpytg0atQzkDBTzP_vkmWvKgj_dNj8kCq87ggBCwhYRoKNgkIGAuITx-Yrkax1ss8H5KJ0CBZeI0HCyqvUf9xUxBFrDfo6zvcpNXeORNTjiGGF-jXX6UoCoVqwsP_eEJ86PmBPtG82YgkFXg7uXB4rtd7LfrsERYOJ0Imhn3VZtpNJhc1s64U8UsbcUiPwvh86yVR1nIICGRpHXwIUd8Hf4kznMUKvnFygkyOnTSg"/>
</div>
<div className="md:col-span-7">
<p className="text-xs font-semibold text-outline mb-2">OCTOBER 12, 2024</p>
<h3 className="text-2xl font-semibold mb-4 tracking-tight">AI Diagnostics Implementation</h3>
<p className="text-on-surface-variant max-w-2xl">Implementing a proprietary machine learning layer to assist radiologists in early detection of micro-calcifications.</p>
</div>
<div className="md:col-span-2 flex justify-end">
<button className="text-primary font-semibold py-2 px-6 border-b-2 border-transparent hover:border-primary transition-all">Read</button>
</div>
...
<div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
<div className="md:col-span-3">
<img className="w-full aspect-[4/3] object-cover grayscale hover:grayscale-0 transition-all duration-500" data-alt="Group of diverse medical professionals in scrubs walking through a high-tech hospital corridor discussing charts" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBqiI2MaUzCDcjQ6plSej4lielHmRTW4x-3dMwqXe7nqEJUMP2nESwd2WPa1KH4kIpzVIZvDdFp7oRe_qChtXPgL2SfpDfDw9iPmfC1MYb9G0RFGtL8DYob2W0ZQAwNihrxT4ZUe-SO7NMGjOoK2MaSqLEAONU-XGyc_8ZX00fwtFETt89WPhppxMc-ZiSfHW_pge5oKdpQLeS2f-WLAbq0eF2HsqFdOo0bbBZKon8mueAJ-pRcz7DyHIfPhloT61JE5_kuW8yCaA"/>
</div>
<div className="md:col-span-7">
