    ...
    <main className="min-h-screen bg-hc-surface px-6 py-20 text-hc-text">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="max-w-2xl text-sm font-medium leading-7 text-hc-text-secondary">
          The patient portal supports appointment review, clinical record access,
          secure messages, billing references, and care preparation. It is not an
          emergency communication channel and does not replace direct clinical
          evaluation.
        </p>
      </div>
    </main>
