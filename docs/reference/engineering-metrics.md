...
| Frontend route/layout file count | Current verified | `web/src/app` | 77 `page.tsx`, `layout.tsx`, and `route.ts` files |
...
| Playwright spec files | Current verified | `web/e2e/specs` | 25 tracked spec files |
