...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 1](activity-diagram.md#flow-1-public-booking)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 2](activity-diagram.md#flow-2-staff-authentication)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 3](activity-diagram.md#flow-3-queue-operations)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 4](activity-diagram.md#flow-4-doctor-clinical)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 5](activity-diagram.md#flow-5-pharmacy-dispense)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 6](activity-diagram.md#flow-6-billing)
...
> 📂 **Activity Diagram:** [Xem Sơ đồ hoạt động của Flow 7](activity-diagram.md#flow-7-patient-portal)
